...
helmchart: kustomize
	...
	sed -i 's/name: controller-manager/name: ${OPERATOR_NAME}-controller-manager/' ./charts/${OPERATOR_NAME}/templates/rbac.yaml
	sed -i 's/namespace: system/namespace: {{.Release.Namespace}}/' ./charts/${OPERATOR_NAME}/templates/rbac.yaml
